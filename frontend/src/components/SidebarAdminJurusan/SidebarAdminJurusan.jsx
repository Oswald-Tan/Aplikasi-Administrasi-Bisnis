...
import { LuBell, LuCalendar, LuList } from "react-icons/lu";
    ...
    if (user?.role === "admin_jurusan") {
      const updatedMenus = [
        ...
        },
        {
          ...
          hasSubMenu: true,
          subMenu: [
            { name: "Admin Prodi", link: "/users/admin" },
            { name: "Mahasiswa", link: "/users/all/mahasiswa" },
            { name: "Dosen", link: "/users/all/dosen" },
          ],
        },
        {
          name: "Agenda Jurusan",
          ...
          hasSubMenu: true,
          subMenu: [
            { name: "Daftar Kegiatan", link: "/events/list" },
            { name: "Kehadiran", link: "/events/attendance" },
          ],
        },
        {
