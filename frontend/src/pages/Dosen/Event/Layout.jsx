...
import { MdSearch, MdKeyboardArrowDown, MdEventNote } from "react-icons/md";
        ...
        <div className="flex flex-col md:flex-row justify-end items-start md:items-center gap-4 mb-4">
          <div className="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
            ...
            <div className="flex items-center relative w-full md:w-48">
              <select
                className="px-4 py-3 border dark:text-white border-gray-300 dark:border-[#3f3f3f] rounded-md text-sm focus:outline-none appearance-none pr-7 bg-white dark:bg-[#282828]"
                value={statusFilter}
                  ...
                  {events.map((event, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 whitespace-nowrap">
                        <div className="flex gap-2">
                          <ButtonAction
                            to={`/dosen/kehadiran-saya?eventId=${event.id}`}
                            icon={<MdEventNote />}
